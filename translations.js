window.translations = {
    en: {
        ...
        time_comparison_desc: "Modern-style time comparison tool for New York and Istanbul.",
        live_demo: "Live Demo",
        upcoming_project: "Upcoming Project",
        upcoming_desc: "It's an undisclosed project, but it's coming soon!",
        ...
        qr_title: "QR Code Generator & Reader",
    ...
    tr: {
        ...
        review8: "\"BT'de sağlam bir temele ve detaylara karşı keskin bir bakış açısına sahip, Kalite Güvence yolculuğu istikrarlı bir şekilde ilerliyor. Sürekli öğrenme ve pratik deneyim, alanda sağlam bir beceri seti oluşturuyor.\"",
        review9: "\"Yazılım testinde yapılandırılmış bir yaklaşım görülüyor, endüstri araçları ve en iyi uygulamalara odaklanılmış. Sorunları tespit etme ve kaliteyi sağlama yeteneği, QA'de parlak bir gelecek vadediyor.\"",
        // reviews //
        ...
        // qr_code //
        qr_title: "QR Kod Oluşturucu ve Okuyucu",
    ...
    ru: {
        ...
        calculator_desc: "Элегантное приложение-калькулятор с базовыми арифметическими операциями и поддержкой клавиатуры",
        rps_title: "Камень, Ножницы, Бумага",
        rps_desc: "Классическая игра с анимированными переходами и отслеживанием счета",
        weather_title: "Динамическое Приложение Погоды",
        weather_desc: "Современное приложение погоды с динамическими фонами, обновлениями в реальном времени и 3-дневным прогнозом",
        ...
        upcoming_desc: "Это еще не раскрытый проект, но он скоро появится!",
        coming_soon: "Скоро",
        ...
        // other //
        close: "×",
        back_to_portfolio: "Вернуться в Портфолио",
        time_comparison: "Сравнение Времени",
                // time_comparison //
                time_comparison: "Сравнение времени",
                minutes: "минуты",
                hours: "часы",
                time_difference: "+8 часов",
                sync_times: "Синхронизировать",
        ...
        // can_tasima //
        can_tasima: "Джан Ташыма",

        // full_stack_dev //
        full_stack_dev: "Fullstack Разработчик",
        ...
        review6: "\"Отличный студент, всегда стремящийся к изучению нового.\"",
        review7: "\"Мяу Мяу. Мяу Мяу Мяу, Мяу Мяу! 😼🐱‍💻\"",
        review8: "\"С прочной основой в IT и острым глазом на детали, путешествие в Обеспечение Качества продолжается стабильно. Непрерывное обучение и практический опыт формируют солидный набор навыков для этой области.\"",
        review9: "\"Очевиден структурированный подход к тестированию программного обеспечения, с фокусом на отраслевые инструменты и лучшие практики. Способность выявлять проблемы и обеспечивать качество указывает на многообещающее будущее в QA.\"",
        // reviews //

        // people //
        karina_blanchette: "Карина Бланшетт",
        dr_adnan_ceylan: "Д-р Аднан Джейлан",
        canan_gunduz: "Джанан Гюндюз",
        kaan_seckin: "Каан Сечкин",
        teoman_yucel: "Теоман Юджель",
        omer_ozan_cayli: "Омер Озан Чайлы",
        riba_chickenlegs: "Риба Куриные Ножки",
        vefa_alas: "Вефа Алас",
        ...
        front_end_course: "Курс Фронтенд-Разработки",
        ...
        // qr_code //
        qr_title: "Генератор и Сканер QR-Кодов",
